...
assert_url_contains "$WEB_URL" "AI Agent 与大模型应用" "home-summary-zh"
assert_url_contains "${WEB_URL}/repositories/langchain-ai/langchain" "为什么值得关注" "detail"
assert_url_contains "${WEB_URL}/repositories/langchain-ai/langchain" "项目说明" "detail-description-zh"
assert_url_contains "${WEB_URL}/repositories/langchain-ai/langchain" "原始说明" "detail-original-description"
